                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_bayar" value="{{$penjualan->tgl_bayar}}" class="form-control" placeholder="Masukan Tanggal Bayar" required>
                                </div>
                                <div class="form-group">
                                    <label for="" class="form-label">Jumlah Bayar</label>
                                    <input type="text" name="jumlah_bayar" value="{{$penjualan->jumlah_bayar}}" class="form-control" placeholder="Masukan Jumlah Bayar" required>
                                </div>
